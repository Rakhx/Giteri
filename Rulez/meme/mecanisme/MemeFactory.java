...
import configurator.Configurator.ActionType;
import configurator.Configurator.AgregatorType;
import configurator.Configurator.AttributType;
import entite.Meme;
...
public class MemeFactory {
	...
	public Meme registerMemeAction(String name, double proba, ActionType actionAsked, ArrayList<AttributType> attributs, Hashtable<AttributType, Hashtable<Integer ,AgregatorType>> KVAttributAgregator, boolean addToList){
		...
		IAction action = ActionFactory.getInstance().getAction(actionAsked);
		@SuppressWarnings("rawtypes")
		ArrayList<IAttribut> attribs = new ArrayList<IAttribut>();
		Hashtable<String, Hashtable<Integer ,IAgregator>> KVAttribAgreg = new Hashtable<String, Hashtable<Integer ,IAgregator>>(); 
		
		IAttribut<?> attribut;
		Hashtable<Integer ,IAgregator> listAgregator;
