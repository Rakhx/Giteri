...
import configurator.Configurator.AgregatorType;
...
public class AgregatorFactory {
	...
	{
		public abstract <T extends Comparable<T>> ArrayList<Entite> applyAggregator(Entite asker, ArrayList<Entite> entites, IAttribut<T> attribut);
	...
	public class TheMost implements IAgregator{
		 ...
		 */
		public <T extends Comparable<T>> ArrayList<Entite> applyAggregator(Entite asker, ArrayList<Entite> entites, IAttribut<T> attribut) {
	...
	public class TheLeast implements IAgregator{
		 ...
		 */
		public <T extends Comparable<T>> ArrayList<Entite> applyAggregator(Entite asker,ArrayList<Entite> entitees, IAttribut<T> attribut) {
			ArrayList<Entite> resultat = new ArrayList<Entite>();
			Entite bestEntitee = null ;
	...
	public class random extends Agregator implements IAgregator {
		...
		public <T extends Comparable<T>> ArrayList<Entite> applyAggregator(
				Entite asker, ArrayList<Entite> entites, IAttribut<T> attribut) {
			if(entites.size() > 1){
